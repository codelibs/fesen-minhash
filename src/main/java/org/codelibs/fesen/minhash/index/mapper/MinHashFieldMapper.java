...
import org.codelibs.fesen.index.fielddata.plain.SortedSetOrdinalsIndexFieldData;
import org.codelibs.fesen.index.mapper.FieldMapper;
import org.codelibs.fesen.index.mapper.MappedFieldType;
import org.codelibs.fesen.index.mapper.Mapper;
import org.codelibs.fesen.index.mapper.Mapper.TypeParser.ParserContext;
...
public class MinHashFieldMapper extends ParametrizedFieldMapper {
    ...
    public static class Builder extends ParametrizedFieldMapper.Builder {
        ...
        private MinHashFieldType buildFieldType(final BuilderContext context,
                final FieldType fieldType) {
            return new MinHashFieldType(buildFullName(context), fieldType,
